...
<h2 class="commercial-heading">Commercial Collection</h2>
...
<p class="container-commercial-p"><?php echo $value['2'];?></p>
<p class="container-commercial-p"><?php echo $value['3'];?></p>
...
<p class="container-commercial-p"><?php echo $value['5'];?></p>
<p class="container-commercial-p"><?php echo $value['6'];?></p>
<p class="container-commercial-p"><?php echo $value['7'];?></p>
<?php
	}?>
