...
<div class="wrapper">
	...
	<ul class="breadcrumb">
			...
			?>
			<form action="uoutside_general.php" method="post">
      ...
      <label for="name">Descrption Part-1</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="about-des" rows="9"><?php echo $value['2']?></textarea>
	      </div>
	  	  <div class="form-group col-md-10">
      <label for="name">Descrption Part-2</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="about-des1" rows="4"><?php echo $value['3']?></textarea>
	     
 </div>
	  <div class="form-group col-md-10">
      <label for="name">H1</label>
      <input type="text" name="h1" value="<?php echo $value['4'];?>" class="form-control" id="name">
	  </div>
	  
	  <div class="form-group col-md-10">
      <label for="name">Descrption Part-3</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="about-des2" rows="4"><?php echo $value['5']?></textarea>
	     
 </div>
	  <div class="form-group col-md-10">
      <label for="name">H2</label>
      <input type="text" name="h2" value="<?php echo $value['6'];?>" class="form-control" id="name">
	  </div>
	  <div class="form-group col-md-10">
      <label for="name">Descrption Part-4</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="about-des3" rows="4"><?php echo $value['7']?></textarea>
	     
 </div>
 <div class="form-group col-md-10">
      <label for="name">H3</label>
      <input type="text" name="h3" value="<?php echo $value['8'];?>" class="form-control" id="name">
	  </div>
	  <div class="form-group col-md-10">
      <label for="name">Descrption Part-5</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="about-des4" rows="9"><?php echo $value['9']?></textarea>
	      </div>
		  <div class="form-group col-md-10">
      <label for="name">Descrption Part-6</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="about-des5" rows="5"><?php echo $value['10']?></textarea>
