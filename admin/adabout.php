...
<div class="wrapper">
	...
	<ul class="breadcrumb">
			...
			?>
			<form action="uadabout.php" method="post">
			 <div class="form-group col-md-10">
      <label for="name">Website Title</label>
      <input type="text" name="title" value="<?php echo $value['1']?>" class="form-control" id="name">
	  </div>
	  <div class="form-group col-md-10">
      <label for="name">Img Title</label>
      <input type="text" name="img_title" value="<?php echo $value['2']?>" class="form-control" id="name">
	  </div>
	  <div class="form-group col-md-10">
      <label for="name">Descrption Part-1</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="about-des" rows="6"><?php echo $value['3']?></textarea>
	      </div>
		  <div class="form-group col-md-10">
      <label for="name">Descrption Part-2</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="about-des1" rows="6"><?php echo $value['4']?></textarea>
	      </div>
		  <div class="form-group col-md-10">
      <label for="name">H3</label>
      <input type="text" name="h3" value="<?php echo $value['5']?>" class="form-control" id="name">
	  </div>
	  <div class="form-group col-md-10">
      <label for="name">Descrption Part-3</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="about-des2" rows="6"><?php echo $value['6']?></textarea>
	      </div>
		  <div class="form-group col-md-10">
      <label for="name">Descrption Part-4</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="about-des3" rows="6"><?php echo $value['7']?></textarea>
	      </div>
			<?php
			}?>
