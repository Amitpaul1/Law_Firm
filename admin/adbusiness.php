...
<div class="wrapper">
	...
	<ul class="breadcrumb">
			...
			?>
			<form action="ubusiness.php" method="post">
      ...
      <input type="text" name="title1" value="<?php echo $value['3']?>" class="form-control" id="name">
	  </div>
	   <div class="form-group col-md-10">
      <label for="name">Descrption Part-2</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="business-des1" rows="5"><?php echo $value['4']?></textarea>
	      </div>
	  
	  <div class="form-group col-md-10">
      <label for="name">Descrption Part-3</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="business-des2" rows="5"><?php echo $value['5']?></textarea>
	      </div>
	  	  <div class="form-group col-md-10">
      <label for="name">Descrption Part-4</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="business-des3" rows="7"><?php echo $value['6']?></textarea>
	      </div>
	  <div class="form-group col-md-10">
      ...
      <label for="name">Descrption Part-5</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="business-des4" rows="7"><?php echo $value['8']?></textarea>
	      </div>
	  <div class="form-group col-md-10">
      ...
      <label for="name">Descrption Part-6</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="business-des5" rows="7"><?php echo $value['10']?></textarea>
	      </div>
		  <div class="form-group col-md-10">
      <label for="name">H4</label>
      <input type="text" name="h4" value="<?php echo $value['11']?>" class="form-control" id="name">
	  </div>
		  <div class="form-group col-md-10">
      <label for="name">Descrption Part-7</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="business-des6" rows="7"><?php echo $value['12']?></textarea>
	      </div>
		  		  <div class="form-group col-md-10">
      <label for="name">H5</label>
      <input type="text" name="h5" value="<?php echo $value['13']?>" class="form-control" id="name">
	  </div>
		  <div class="form-group col-md-10">
      <label for="name">Descrption Part-8</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="business-des7" rows="7"><?php echo $value['14']?></textarea>
	      </div>
		  
			<?php
			}?>
			<input type="submit" class="btn btn-primary btn-lg mt-2 mb-4" value="Save" name="submit" />
</form>
</div>
    </div>
    </div>
