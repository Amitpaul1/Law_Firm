...
<div class="wrapper">
	...
	<ul class="breadcrumb">
			...
			$sql="SELECT * FROM `commercial_collection`";
			$res=$pdo->query($sql);
			...
			?>
			<form action="ucommercial.php" method="post">
      ...
      <label for="name">Descrption Part-1</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="about-des" rows="7"><?php echo $value['2']?></textarea>
	      </div>
	  	   <div class="form-group col-md-10">
      <label for="name">Descrption Part-2</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="about-des1" rows="6"><?php echo $value['3']?></textarea>
	      </div>
	  <div class="form-group col-md-10">
      ...
      <label for="name">Descrption Part-3</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="about-des2" rows="6"><?php echo $value['5']?></textarea>
	      </div>
		  
		   <div class="form-group col-md-10">
      <label for="name">Descrption Part-4</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="about-des3" rows="6"><?php echo $value['6']?></textarea>
	      </div>
		  
		  
		   <div class="form-group col-md-10">
      <label for="name">Descrption Part-5</label>
	      <textarea class="form-control" id="exampleFormControlTextarea1" name="about-des4" rows="6"><?php echo $value['7']?></textarea>
	      </div>
	<?php
			}?>
